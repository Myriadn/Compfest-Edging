function love.conf(t)
    ...
    t.window.title              = "Funabulist"                      -- The window title (string)
    t.window.icon               = "icon/icon.png"                   -- Filepath to an image to use as the window's icon (string)
    t.window.width              = 1280                              -- The window width (number)
    t.window.height             = 720                               -- The window height (number)
    t.window.borderless         = false                             -- Remove all border visuals from the window (boolean)
    t.window.resizable          = true                              -- Let the window be user-resizable (boolean)
    t.window.minwidth           = 854                               -- Minimum window width if the window is resizable (number)
